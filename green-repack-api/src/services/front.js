...
const marchandFindOneById = require('../modules/marchands/services/findOneById');
const marchandCreateOne = require('../modules/marchands/services/createOne');
const marchandFind = require('../modules/marchands/services/find');
...
router.get('/marchands', (req, res, next) => {
  marchandFind()
    .then((marchands) => {
      res.render('marchands', { marchands });
    })
    .catch((err) => {
      next(err);
    });
...
router.get('/marchands/create', (req, res) => {
  res.render('createMarchand');
});

router.post('/marchands/created', (req, res, next) => {
  const marchandToCreate = req.body;

  marchandCreateOne(marchandToCreate)
    .then((marchand) => {
      res.render('marchandCreated', { marchand });
    })
    .catch((err) => {
      next(err);
    });
...
router.get('/marchands/:marchandId', (req, res, next) => {
  const {
    marchandId,
  } = req.params;

  marchandFindOneById(marchandId)
    .then((marchand) => {
      res.render('marchand', { marchand });
    })
    .catch((err) => {
      next(err);
    });
